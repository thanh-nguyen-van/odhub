...
define('USER_SESSION_NAME',		'user_session_name');
define('USER_SESSION_FULLNAME',	'user_session_fullname');
define('USER_SESSION_EMAIL',	'user_session_email');
define('USER_SESSION_TYPE',		'user_session_type');
...
else
{
	...
	$config['base_url']						= $PROTOCOL.$_SERVER['HTTP_HOST']."/site/";
	$config['server_absolute_path'] 		= $_SERVER['DOCUMENT_ROOT']."/site";  
	$config['file_upload_absolute_path'] 	= $_SERVER['DOCUMENT_ROOT']."/upload";
