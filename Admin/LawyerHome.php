...
if((!empty($_POST))&&(isset($_POST['submit'])))
{
    ...
    $query="UPADATE ".$table['staticpage']." SET StaticPageText='".$pagedata."' WHERE StaticPageName='lawyer-home'";
    $result=mysql_query($query);
    $msg="<font color=red>Successfully Updated</font>";
 }
 else
{
    $dataQuery="SELECT * FROM ".$table['staticpage']." WHERE StaticPageName='lawyer-home'";
...
?>
<FORM METHOD="post" ACTION="LawyerHome.php"><br />
<br />
