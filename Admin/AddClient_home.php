...
<table width="100%" class="whitetable">
	<tr>
		<td colspan="5"><h3>Add Home Page Details</h3></td>
	</tr>
	<form action="AddHomeValidate.php" method="post" enctype="multipart/form-data" >
		<tr>
		...
		<tr>
			<td class="tdhead"><font color="red">*</font> Content:</td>
