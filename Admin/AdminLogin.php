        ...
        <div class="lgt-blue">
            <div class="dp-blue">
                ...
                <form action="LoginMessage.php" method="post">
                    ...
                    <div class="log-main">
                        <?php if ($_SESSION['err_msg'] != '') {echo $_SESSION['err_msg'];unset($_SESSION['err_msg']); } ?>
                        <div><input type="text" name="username" onFocus="if (this.value == 'User name...')
                                    this.value = '';" onBlur="if (this.value == '')
                                    this.value = 'User name...';
                                else
                                    this.value = this.value;" value="User name..." class="input1"  /> </div>
                        <div><input type="password" name="password" onFocus="if (this.value == 'Password')
                                    this.value = '';" onBlur="if (this.value == '')
                                    this.value = 'Password';
                                else
                                    this.value = this.value;" value="Password" class="input1"  />  </div>
