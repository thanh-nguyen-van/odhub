...
<tr>
	...
	<form  method="post" action="LawyerCategoryAddEditPerform.php">
	    <tr>
        	<?php if($re!="") { ?>
            <input type="hidden" name="categoryid" value="<?echo $re['LawyerCategoryId'];?>"><?php } ?>
            <td width="74%" align="left" valign="middle"><input type="text" name="LawyerCategoryName" value="<? if($re!="") { echo $re['LawyerCategoryName']; } ?>" class="input12">&nbsp;<?echo $err;?><?echo $category_label;?></td>
          <td width="26%" align="left" valign="middle"><input type="submit" name="submit" value="submit" class="buttn"></td>
        </tr>
    </form>
</table>
</div>
